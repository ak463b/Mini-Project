...
def runtest(example_file_path):
    ...
    def extract_features(file_path):
        try:
            audio, sample_rate = librosa.load("C:\\Users\\alokk\\Downloads\\data\\data", res_type='kaiser_fast') 
            mfccs = np.mean(librosa.feature.mfcc(y=audio, sr=sample_rate, n_mfcc=40).T, axis=0)
            return mfccs
        except Exception as e:
            print("Error encountered while parsing file:", "C:\\Users\\alokk\\Downloads\\data\\data")
            return None

    example_features = extract_features("C:\\Users\\alokk\\Downloads\\data\\data")
